let questions = [
    ...
    {
    numb: 2,
    question: "Which cricketer has made the highest individual score at the World Cup?" ,
    ...
    {
    numb: 3,
    question: "Who took the first hattrick in an IPL match?",
    ...
    {
    numb: 5,
    question: "What is the largest cricket stadium in the world (area wise)?",
    answer: "Melbourne Cricket Club",
    options: [
        "Eden Gardens",
